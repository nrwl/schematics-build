...
function default_1(options) {
    ...
    var templateSource = schematics_1.apply(schematics_1.url('./files'), [schematics_1.template(__assign({ utils: stringUtils, dot: '.', nxVersion: lib_versions_1.nxVersion, schematicsVersion: lib_versions_1.schematicsVersion }, options, { npmScope: npmScope }))]);
